...
<body>
    <div class="container">
        ...
        <!-- <div class="demo-hint">
            ...
            Supervisor: name@mtn.com / mypassword123<br>
            Intern: name@mtn.com / intern123
        </div>
      -->
        <div class="footer">
    ...
    <script>
        ...
        //     if (type === 'supervisor') {
        //         document.getElementById('email').value = 'admin@mtn.com';
        //         document.getElementById('password').value = 'password123';
        //     } else if (type === 'intern') {
        //         document.getElementById('email').value = 'intern@mtn.com';
